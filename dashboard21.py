...
# # def load_lstm_model():
# #     try:
# #         model = tf.keras.models.load_model("lstm_model.h5", custom_objects={"mse": mse}, compile=False)
# #         return model
...
#     if selected_page == "📊 Model Performance":
#         st.header("📊 Model Performance Metrics")
#         st.metric("Crop Yield MAE", "Lower than before 🎯")
#         st.metric("Price Prediction RMSE", "More accurate than before 🎯")
